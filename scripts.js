  ...
  if (number < 0 || number > 1000000) {
    ...
    function transformNumberText(number){
      ...
      if (number < 1000000) {
        ...
        (Math.floor(number / 1000) % 100 < 20 && Math.floor(number / 1000) % 100 > 0 ? ' e ' + unidade[Math.floor(number / 1000) % 100] : '' ) +
        (Math.floor(number / 1000) % 100 < 100 && Math.floor(number / 1000) % 100 >= 20 ? ' e ' + dezenaDezena[Math.floor(((number / 1000) % 100) / 10)] : '' ) +
        (Math.floor((number / 1000) % 100) % 10 !== 0 && Math.floor(number / 1000) % 100 > 20 ? ' e ' + unidade[Math.floor(((number / 1000) % 100) % 10)] + ' mil ' : ' mil ') +
        (number % 1000 === 100 ? ' e cem' : '' ) +
        (number % 1000 === 200 ? ' e cuzentos' : '' ) +
        (number % 1000 === 300 ? ' e trezentos' : '' ) +
        (number % 1000 === 400 ? ' e quatrocentos' : '' ) +
